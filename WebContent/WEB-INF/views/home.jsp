			    ...
			    <c:forEach items="${cates}" var="c" varStatus="vs">
			    	...
			    	<div class="col-xs-6 col-md-3">
			    		<div class="thumbnail">
			    			...
			    			<img width="242" height="200" src="${pageContext.request.contextPath}${c.catePic}" alt="${c.cateName}"></a>
			  ...
			  <div class="panel-body">			    			   		    
				<div id="newGoodsCarousel" class="carousel slide goods" data-ride="carousel">								   
					  ...
					  <c:if test="${!empty newGoods }">
					    ...
					    <c:forEach begin="0" end="${(fn:length(newGoods)+3)/4-1}" var="i" varStatus="vs">								
								...
								<c:forEach begin="0" end="3" var="j">
				                	...
				                	<div class="col-md-3">
				                		...
				                		<img width="242" height="200" src="${pageContext.request.contextPath}${newGoods[index].goodsPic}" alt="Image" class="img-responsive"></a>
				                		<div class="container">
			  ...
			  <div class="panel-body" >
			    <div id="salesGoodsCarousel" class="carousel slide goods" data-ride="carousel">								   
					  ...
					  <c:if test="${!empty salesGoods }">
					  	<c:set var="index" value="0"/>
					    <c:forEach begin="0" end="${(fn:length(salesGoods)+3)/4-1}" var="i" varStatus="vs">								
								<div class="item ${vs.first?'active':''} goods" >
								<div class="row">									
								<c:forEach begin="0" end="3" var="j">
				                	...
				                	<div class="col-md-3">
				                		...
				                		<img width="242" height="200" src="${pageContext.request.contextPath}${salesGoods[index].goodsPic}" alt="Image" class="img-responsive"></a>
				                		<div class="container">
