			...
			<c:forEach items="${cates}" var="c">
				<div class="col-md-3">
					<div class="thumbnail">
			    		...
			    		<img src="${pageContext.request.contextPath}${fn:escapeXml(c.catePic)}" alt="${fn:escapeXml(c.cateName)}"></a>
			    		<div class="caption" align="center"><p>${fn:escapeXml(c.cateName)}</p></div>
					</div>
				</div>
			</c:forEach>
			</c:if>		
