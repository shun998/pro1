    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                  	...
                  	<a href="${pageContext.request.contextPath}/admin/cate/delCate?cateId=${cate.cateId}" onclick="return confirm('将删除此分类和此分类下所有商品，确定要删除这个分类吗？')">删除</a>   
				  </td>
                </tr>
               </c:forEach>
              </tbody>
          ...
          <c:if test="${empty cates.list }">暂无商品分类信息</c:if>
        </div>
      </div>
    </div>
