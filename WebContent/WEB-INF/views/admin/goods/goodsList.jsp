...
function selGoodsBut(formId,cbName){
...
function check(){
	if(!validateCheckbox("goodsForm","goodsIds","请至少选中一个商品"))
		return false;
	else
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
         <div class="row">
          ...
          <div class="table-responsive ">
          	<form id="goodsForm" method="post" action="${pageContext.request.contextPath}/admin/goods/delGoodsByIds" onsubmit="return check()">
