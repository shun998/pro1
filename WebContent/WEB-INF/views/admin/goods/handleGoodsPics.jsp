        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="col-sm-6 col-sm-offset-3 col-md-8 col-md-offset-2">
            ...
            <c:forEach items="${goods.pics }" var="p">
            	...
            	<a href="${pageContext.request.contextPath}/admin/goods/delGoodsPics?picId=${p.picId}&goodsId=${goods.goodsId}" class="btn btn-primary" onclick="return confirm('确定要删除这张图片吗？')">删除图片</a>
            	</div>
            	</div>
			</c:forEach>
			</c:if>
